...
def main():
    ...
    pygame.display.set_caption("Peterson's Tetris")

    showTextScreen('Tetris')
    while True:        # game loop
        if random.randint(0, 1) == 0:
            pygame.mixer.music.load('BBL Drizzy.mp3')
        else:
           pygame.mixer.music.load('BBL Drizzy.mp3')
...
def runGame():
    ...
    while True:        # main game loop
        ...
        for event in pygame.event.get():            # event handling loop
            ...
            elif event.type == KEYDOWN:    # moving the block sideways
...
def addToBoard(board, piece): #  fill in the board based on piece's location, shape, and rot
